...
시장에는 '알아서 해'와 '맡겨'만 있었다. '네가 하되, 시스템으로 해'는 없었다.

정보, 분석 도구, 매매 앱 — 부품은 다 있다.<br>
하지만 이걸 하나의 프로세스로 작동시키는 시스템은 없다.<br>
개인투자자는 매번 맨손으로 조립하고 있다.<br>
"개인투자자에게는 투자 시스템이 없다."
...
| [**api**](https://github.com/vinjung/alphafolio_api) | AI 비서 백엔드 API | FastAPI, LangGraph, ChromaDB, Fine-tuned GPT |
